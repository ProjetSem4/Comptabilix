                ...
                <?php
				$templacat->set_variable("page_title", "Visualiser un projet");
				?>
				
                <div class="panel panel-default contenu-page">
					<p><a href="salaries_voir.php">« Retourner à la liste des projets</a></p>
                    <h1>Fiche projet <a class="btn btn-warning pull-right" href="#"><span class="glyphicon glyphicon-pencil"></span> Éditer le projet</a></h1>
					<table class="table">
						<tr>
							<td class="titre-tableau">Nom</td>
							<td><span class="glyphicon glyphicon-user"></span> Truc Chose</td>
						</tr>
						<tr>
