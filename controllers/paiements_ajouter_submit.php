<?php
    ...
    else
    {
        ...
        {
            $query_insert_devis_societe = $slim->pdo->prepare('INSERT INTO ' . $config['db_prefix'] . 'T_Paiement (num_devis, id_societe, date_paiement, quantite_payee) VALUES (:nd, :is, :dp, :qp)');
