<?php
    ...
    // Query the database
    $query = $slim->pdo->query('SELECT * FROM T_Service WHERE num_service = ' . $_GET['id']);
...
<div class="panel panel-default contenu-page">
    ...
    <form class="" role="form" method="post" action="services_editer_submit">        
        <div class="form-group col-sm-12">
            ...
            <div class="input-group">
                ...
                <input id="libelle" name="libelle" type="text" class="form-control" placeholder="Titre du service" value="<?php echo $line['libelle']; ?>" required>
            </div>
        </div>  
        ...
        <div class="form-group col-sm-12">
            ...
            <div class="input-group">
                ...
                <input id="tarif" name="tarif" type="text" class="form-control" placeholder="En <?php echo $config['currency']; ?>" value="<?php echo $line['tarif_mensuel']; ?>" required>
            </div>
        </div>

        <input type="hidden" name="num_service" value="<?php echo $line['num_service']; ?>" />

        <button type="reset" class="btn btn-danger">Remettre à zéro le formulaire</button>
        <button type="submit" class="btn btn-success">Éditer le service</button>
    </form>
</div>