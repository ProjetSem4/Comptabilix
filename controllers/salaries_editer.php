...
<div class="panel panel-default contenu-page">
    ...
    <h1>Éditer une fiche salarié</h1>
                    
    <form class="" role="form" method="post" action="salaries_editer_submit">
        <input id=id_salarie name="id_salarie" type="hidden" value="<?php echo $line['id_personne']; ?>" >
        ...
        <button type="submit" class="btn btn-success">Editer le salarié</button>
    </form>                 
</div>