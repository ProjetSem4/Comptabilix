				<?php
				$templacat->set_variable("page_title", "Visualiser les salariés");
				?>
                
                <div class="panel panel-default contenu-page">
					<p><a href="salaries_voir.php">« Retourner à la liste des salariés</a></p>
                    <h1>Fiche salarié <a class="btn btn-warning pull-right" href="#"><span class="glyphicon glyphicon-pencil"></span> Éditer le salarié</a></h1>
					<table class="table">
						<tr>
