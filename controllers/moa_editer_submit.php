<?php
    ...
    if(!isset($_POST['id_moa'], $_POST['prenom'], $_POST['nom'], $_POST['adresse'], $_POST['cp'], $_POST['ville'], $_POST['tel'], $_POST['email']))
    ...
    elseif(empty($_POST['prenom']) || empty($_POST['nom']) || empty($_POST['adresse']) || empty($_POST['cp']) && empty($_POST['ville']) || empty($_POST['tel']) || empty($_POST['email']) || empty($_POST['id_moa']))
    ...
    else
    {
        ...
        $query_update_t_personne->bindParam(':idp', $_POST['id_moa']);
        ...
        $query_update_societe->bindParam(':idp', $_POST['id_moa']);
        $query_update_societe->bindParam(':prenom', $_POST['prenom']);
        $query_update_societe->bindParam(':nom', $_POST['nom']);

        $query_update_societe->execute();

        // And finally go back to the right page
        $_SESSION['fortitudo_messages'][] = array('type' => 'success', 'content' => 'Le MOA a été modifié avec succès.');
    }
    ...
    header('Location: moa_editer?id=' . $_POST['id_moa']);
?>